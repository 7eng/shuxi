...
>
> ![开发_发布_生产](/Users/baisong/IdeaProjects/shuxi/doc/images/开发_发布_生产.png)
>
...
<img src="images/上传资源c.png" style="zoom:100%" /><center>图 2-2-3 新建资源步骤(a)</center>

输入资源名: student_info，资源类型: txt，选择文件时添加上面的student_info.txt，点击**确定**完成。如图2-2-4所示：

<img src="images/上传资源d.png" style="zoom:100%" /><center>图 2-2-4 新建资源步骤(b)</center>
...
右击要删除的任务，选择**删除离线任务**，点击**确定**，完成删除。如图3-1-1-5、3-1-1-6 所示 
...
- student_info.txt	-- 资源上传以后，默认提交。如果需要再次提交，可以在资源所在页面点击提交。
- ddl_quick_start_student_info
- quick_start_student_info
- quick_start_student_statistics

quick_start_student_statistics任务提交，如图3-1-1-10 所示：
...
数栖开发平台推荐使用数据仓库的概念进行数据开发。数据仓库分层标准为：ods、dwd、tdm、adm、dim。任务依赖关系如图4-2-1所示
